...
class EdgeTypeView:
    ...
    def render(self, edge_types: List[Dict[str, Any]]) -> html.Div:
        return html.Div([
            self._render_toast(),
            html.Div([
    ...
    def _render_toast(self) -> dbc.Toast:
        return dbc.Toast(
            id="toast-message",
            header="Notification",
            is_open=False,
    ...
    def _render_toolbar(self) -> html.Div:
        return html.Div([
            html.Div([
                html.Div([
                    dbc.Button(
    ...
    def create_delete_modal_body(selected_names: List[str]) -> html.Div:
        ...
        """
        return html.Div([
            html.P(f"Are you sure you want to delete the following {len(selected_names)} edge type(s)?"),
